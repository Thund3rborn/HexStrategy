...
//created with help of: https://www.youtube.com/watch?v=EPaSmQ2vtek
...
public class HexGrid : MonoBehaviour
{
    ...
    protected Vector3 GetPoint(float size, float height, int index)
    {
        ...
        double angle_rad = Math.PI / 180f * angle_deg;
        return new Vector3(size * Mathf.Cos((float)angle_rad), height, size * (float)(Math.Sin(angle_rad)));
    }
